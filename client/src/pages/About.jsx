  ...
  return (
    <>
      <SEO
        ...
        description="Meet Out Experienced Dentists"
      />
            ...
            <motion.div variants={fadeRight} className="space-y-5">
              <div className="flex items-start gap-3">
                ...
                <p className="text-gray-600 leading-relaxed text-justify">
                  At Baishdhara Dental Clinic, we create healthy, confident
                  smiles through expert care and a personal touch. Located in
                  Balaju, Kathmandu, we combine modern dental technology with
                  genuine compassion to deliver precise, comfortable, and
                  trusted treatment for every patient.
                </p>
              </div>
              ...
              <div className="flex items-start gap-3">
                <PointerIcon className="w-5 h-5 text-[#0b2a4a] rotate-90 mt-1 flex-shrink-0" />
                <p className="text-gray-600 leading-relaxed text-justify">
                  Founded in 2021 and inspired by the heritage of Baishdhara,
                  our mission is simple — make high-quality, ethical, and
                  affordable dental care accessible to every family. From
                  routine checkups to advanced implants and smile
                  transformations, every treatment is designed with accuracy,
                  transparency, and long-term oral health in mind.
                </p>
              </div>
